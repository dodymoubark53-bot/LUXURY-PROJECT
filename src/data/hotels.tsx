...
export const getHotelsByCity = (city: string): HotelItem[] => {
  return hotelsData.filter(h => h.city.toLowerCase() === city.toLowerCase());
};

export const getHotelsByDestination = (dest: string): HotelItem[] => {
  return hotelsData.filter(h => h.destination.toLowerCase() === dest.toLowerCase());
};

export const getHotelById = (id: string): HotelItem | undefined => {
