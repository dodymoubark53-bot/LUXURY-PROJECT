...
export const transportationData: TransportItem[] = [
  {
    id: 'tr-bus-1',
...
export const getTransportByCategory = (category: string): TransportItem[] => {
  return transportationData.filter(t => t.category.toLowerCase() === category.toLowerCase());
};

export const getTransportById = (id: string): TransportItem | undefined => {
  return transportationData.find(t => t.id === id);
};
