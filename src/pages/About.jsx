...
const About = () => {
  ...
  return (
    <div className="w-full bg-obsidian-50 pb-24">
      <Helmet>
        <title>{t('about.seoTitle', 'About Us | Luxury Travel')}</title>
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <motion.div className="relative z-10 text-center" variants={staggerContainer} initial="hidden" animate="visible">
          ...
          <motion.h1 variants={fadeInUp} className="text-display-xl text-ivory-50">{t('about.title', 'About Us')}</motion.h1>
        </motion.div>
      </section>
      ...
      <section className="container mx-auto px-6 py-24">
        <motion.div className="max-w-4xl mx-auto text-center" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          <motion.h2 variants={fadeInUp} className="text-display-lg text-obsidian-900 mb-8">{t('about.subtitle', 'Redefining Luxury Travel Since 2010')}</motion.h2>
